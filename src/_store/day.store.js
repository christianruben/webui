...
export const days = {
    ...
    actions: {
        storeReq({commit}, {index, rows, search, sortby, sort}){
            ...
            day.list({index: index, rows: rows, search: search, sortby: sortby, sort: sort}, (result)=>{
